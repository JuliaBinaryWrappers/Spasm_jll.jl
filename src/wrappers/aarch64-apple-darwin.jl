# Autogenerated wrapper script for Spasm_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(spasm, "@rpath/libspasm.dylib")
...
function __init__()
    JLLWrappers.@generate_init_header(Givaro_jll, FFLAS_FFPACK_jll, argp_standalone_jll, libblastrampoline_jll, GMP_jll, LLVMOpenMP_jll)
